...
plt.title('Relationship between Walk-in Rate and CSI (Complexity Score Index) for Walk-in Appointments')
plt.xlabel('Lambda (Rate of Walk-in Appointments per Month)')
